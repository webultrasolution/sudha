                    ...
                    <div style="display: flex; flex-direction: column; gap: 5px; align-items: flex-end;">
                        <?php foreach($ids as $i => $id): ?>
                            <div style="height: 38px; display: flex; align-items: center; gap: 8px;">
                                <a href="create_printing_po.php?action=edit&id=<?php echo $id; ?>" class="btn-icon" style="color: #0284c7; background: #e0f2fe; padding: 6px; border-radius: 8px; font-size: 0.85rem; display: inline-flex; align-items: center; justify-content: center; width: 28px; height: 28px; border: none; text-decoration: none;" title="Edit">
