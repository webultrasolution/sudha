...
<body>
    ...
    foreach ($visual_data as $v):
        ...
        <div class="asset-slide">
            <div
                style="margin-bottom: 20px; display: flex; justify-content: space-between; align-items: flex-end; border-bottom: 2px solid #f1f5f9; padding-bottom: 10px;">
                <img src="../../assets/img/LOGO.png" style="height: 40px; width: auto;">
                <div style="font-weight: 800; color: var(--slate); text-transform: uppercase; font-size: 12px;">
                    <?php echo $proposal['campaign_name']; ?></div>
            </div>
