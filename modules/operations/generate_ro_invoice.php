        ...
        <div class="main-info">
            ...
            <div class="info-col">
                ...
                <div class="info-row">
                    ...
                    <span class="info-sep">:</span>
                    <span
                        class="info-value"><?php echo (!empty($invoiceData['invoice_date']) && $invoiceData['invoice_date'] !== '0000-00-00') ? date('d-m-Y', strtotime($invoiceData['invoice_date'])) : date('d-m-Y'); ?></span>
                </div>
                <div class="info-row">
