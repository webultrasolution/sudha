...
<head>
    ...
    <style>
        body { margin: 0; padding: 20px; font-family: 'Roboto', Arial, sans-serif; background: #525659; }
        .po-container { max-width: 800px; margin: 0 auto; background: #fff; padding: 30px; box-shadow: 0 0 10px rgba(0,0,0,0.5); }
        ...
        @media print {
            ...
            .po-container { box-shadow: none; max-width: 100%; padding: 0; }
...
<div class="po-container">
    ...
    <div class="po-title">PRINTING PURCHASE ORDER</div>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>,1<?php echo number_format($item['monthly_rate'], 2); ?></td>
